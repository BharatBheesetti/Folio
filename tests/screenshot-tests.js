...
// Right-to-left: theme(744,24), outline(708,24), +(676,24), sidebar(644,24)
const BTN = {
  theme:    { x: 744, y: 24 },
  outline:  { x: 708, y: 24 },
  sidebar:  { x: 644, y: 24 },
...
async function runTests() {
  ...
  //   open file → sidebar → dark mode → zoom in → outline → search
  //   → close search → close outline → reset zoom → light mode → close sidebar
  // ─────────────────────────────────────────────────────────
